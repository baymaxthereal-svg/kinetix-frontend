    ...
    return (
        <main className="min-h-screen bg-surface">
            <div className="max-w-7xl mx-auto space-y-6 p-4 md:p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white p-5 md:p-8 rounded-2xl shadow-sm">
                    <div className="space-y-2">
                        ...
                        <h1 className="text-3xl md:text-4xl font-extrabold text-sky-900 tracking-tight break-all">
                            #{order.id}
                        </h1>
                        <div className="flex flex-wrap items-center gap-2">
                            <span className={`flex items-center gap-1.5 px-3 py-1 ${statusDisplay.color} rounded-lg text-xs font-bold whitespace-nowrap`}>
                    ...
                    <div className="flex items-center gap-3">
                        <button className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white font-bold text-sm rounded-xl shadow-md hover:opacity-90 transition-all">
                ...
                {/* Info cards – one column on mobile, three on desktop */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div className="bg-white p-5 rounded-2xl space-y-3">
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <p className="text-sm font-semibold text-slate-900 break-words">{order.name}</p>
                            </div>
                            <div>
                        ...
                        <div className="space-y-3 pt-1">
                            ...
                            {paymentScreenshotUrl && isImage(paymentScreenshotUrl) && (
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-600 break-all">Payment Screenshot</span>
                                    </div>
                            ...
                            {paymentScreenshotUrl && !isImage(paymentScreenshotUrl) && (
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-600 break-all">Payment PDF</span>
                                    </div>
                                    <span className="material-symbols-outlined text-primary text-sm flex-shrink-0">open_in_new</span>
                                </a>
                            )}
                            <div className="grid grid-cols-2 gap-3 pt-2">
                                <div className="p-3 bg-slate-50 rounded-xl">
                                    ...
                                    <p className="text-sm font-extrabold text-slate-900">Rs {totalAmount.toFixed(2)}</p>
                                </div>
                                <div className="p-3 bg-secondary-fixed/30 rounded-xl">
                                    <p className="text-[10px] text-secondary font-bold">PAID</p>
                                    <p className="text-sm font-extrabold text-secondary">Rs {paidAmount.toFixed(2)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-5 rounded-2xl space-y-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm leading-relaxed text-slate-700 mt-1 break-words">
                                {order.address}<br />
                                {order.city}, {order.postal_code || ""}
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
                        ...
                        <table className="w-full text-left border-collapse min-w-[500px]">
                            <thead>
                                <tr className="bg-slate-50/50">
                                    ...
                                    <th className="px-4 py-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Unit Price</th>
                                    <th className="px-4 py-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Qty</th>
                                    <th className="px-5 py-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">Total</th>
                                </tr>
                            </thead>
                                    ...
                                    return (
                                        <tr key={idx} className="hover:bg-slate-50/30 transition-colors">
                                            <td className="px-5 py-4">
                                                <p className="text-sm font-bold text-slate-900 break-words">{item.product_name}</p>
                                            </td>
                                            ...
                                            <td className="px-5 py-4 text-sm font-bold text-slate-900 text-right whitespace-nowrap">
                    ...
                    {/* Totals section – responsive stacking */}
                    <div className="p-5 bg-slate-50/50 flex flex-col md:flex-row justify-between gap-6 border-t border-slate-100">
                        ...
                        <div className="w-full md:w-72 space-y-2">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="text-slate-900 font-semibold">Rs {totalAmount.toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-slate-500 font-medium">Shipping (Insured)</span>
                                <span className="text-slate-900 font-semibold">Rs 0.00</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                            ...
                            <div className="pt-3 border-t border-slate-200">
                                <div className="flex justify-between items-center">
                                    <span className="font-extrabold text-base md:text-lg text-slate-900">Grand Total</span>
                                    <span className="font-extrabold text-xl md:text-2xl text-primary">Rs {totalAmount.toFixed(2)}</span>
                                </div>
                                <div className="mt-2 text-right">
                                    <span className="inline-block text-[10px] font-bold text-secondary bg-secondary/20 px-2 py-0.5 rounded-full uppercase tracking-widest">
                ...
                {/* Footer meta – responsive flex wrap */}
                <div className="flex flex-col md:flex-row justify-between gap-2 text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] px-2">
